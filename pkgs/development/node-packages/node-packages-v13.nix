...
let
  sources = {
    ...
    "resolve-1.13.0" = {
      ...
      version = "1.13.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/resolve/-/resolve-1.13.0.tgz";
        sha512 = "HHZ3hmOrk5SvybTb18xq4Ek2uLqLO5/goFCYUyvn26nWox4hdlKlfC/+dChIZ6qc4ZeYcN9ekTz0yyHsFgumMw==";
      };
    };
    "retry-0.10.1" = {
      name = "retry";
